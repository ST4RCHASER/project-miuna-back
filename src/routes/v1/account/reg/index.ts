...
router.post('/', async (_, res) => {
  ...
  console.log(body)
  try {
    if (!body || !body.email || !body.username || !body.password || !body.name || !body.sec || !body.student_id || !body.major) {
      console.log(body);
    ...
    makeNewUser(db, body.email, body.username, body.password, body.name, body.sec, body.student_id, body.major)
    const response: RESTResp<never> = {
      success: true,
      statusCode: 201,
